...
@RoutePage()
class TotalAdmitListingScreen extends ConsumerStatefulWidget {
  const TotalAdmitListingScreen({super.key});

  @override
  ConsumerState<TotalAdmitListingScreen> createState() => _TotalAdmitListingScreenState();
}

class _TotalAdmitListingScreenState extends ConsumerState<TotalAdmitListingScreen> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("Admit Patients", style: GoogleFonts.poppins(color: Colors.black, fontSize: 25, fontWeight: FontWeight.w500),),
        ),
        body: Padding(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text("Room : WH3 - BED 1", style: GoogleFonts.poppins(color: Colors.blueAccent, fontWeight: FontWeight.w500, fontSize: 13),),
                        ],
                      ),
                      Divider(),
                      Row(
                        ...
                        children: [
                          Flexible(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Room Name : MALE B1", style: GoogleFonts.poppins(color: Colors.black, fontWeight: FontWeight.w500, fontSize: 13),),
