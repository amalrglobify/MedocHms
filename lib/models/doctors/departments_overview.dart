class DepartmentsOverviewModel {
  List<DepartmentsOverviewList>? departmentsOverviewList;
  bool? success;

  DepartmentsOverviewModel({this.departmentsOverviewList, this.success});

  DepartmentsOverviewModel.fromJson(Map<String, dynamic> json) {
    if (json['oList'] != null) {
      departmentsOverviewList = <DepartmentsOverviewList>[];
      json['oList'].forEach((v) {
        departmentsOverviewList!.add(new DepartmentsOverviewList.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.departmentsOverviewList != null) {
      data['oList'] = this.departmentsOverviewList!.map((v) => v.toJson()).toList();
    }
...
class DepartmentsOverviewList {
  ...
  DepartmentsOverviewList.fromJson(Map<String, dynamic> json) {
    status = json['Status'];
